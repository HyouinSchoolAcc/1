...
func (a *App) handleRegister(w http.ResponseWriter, r *http.Request) {
	var req struct {
		...
		EditorPassword string `json:"editor_password"`
	}
	...
	// Determine role - default is writer, editor requires password
	userRole := "writer"
	if req.Role == "editor" {
		ip := getRealIP(r)
	...
	_, err = a.db.Exec(query, userID, req.Username, req.Email, string(hashedPassword), userRole)
	if err != nil {
